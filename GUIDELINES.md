...
- **Code Quality and Formatting**: Use tools like SonarLint for identifying code issues and ensuring consistent code quality.
- **Adhere to the Kerberos protocol**: All petitions should be verified through the established Kerberos system.
